...
let question = [
    ...
    new Question("Javascript is a", ["Language", "Programming Language", "Developement", "All"], "Programming Language")
]
...
function showScores() {
    ...
    quizOverHtml += "<h2 id='score'> Your Scores: " + quiz.score + ". And Percentage is:  " + (quiz.score / question.length * 100) + "%" + "</h2>";
